app.controller("notificationData", function ($scope, $http, $timeout) {
  $scope._search = {};
  ...
  $scope.updateGov = function () {
    ...
    $http({
      method: "POST",
      url: "/api/notificationData/update",
      data: $scope.gov
    }).then(
      function (response) {
        $scope.busy = false;
  ...
  $scope.deleteGov = function () {
    ...
    $http({
      method: "POST",
      url: "/api/notificationData/delete",
      data: {
        id: $scope.gov.id
      }
    }).then(
